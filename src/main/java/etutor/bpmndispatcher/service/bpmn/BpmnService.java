package etutor.bpmndispatcher.service.bpmn;
...
public class BpmnService {
    ...
    public BpmnService(ApplicationProperties properties, SubmissionDispatcherService dispatcherService, GradingDTORepository gradingDTORepository, TestConfigDTORepository testConfigDTORepository) {
    ...
    public Long updateExercise(TestConfigDTO testConfigDTO, Long id) throws Exception {
        ...
        if (dbTestconfig.isEmpty()) throw new Exception("no Exercise with id: " + id);
        TestConfigDTO dbResult;
        dbResult = testConfigDTO;
